...
<body>
    ...
    <main class="perfil">
        ...
        <div class="perfil__link"><img class="perfil__imagem" src="./assets/perfil.png" alt=""> <p>${usuarioLogado.nome} <br> ${usuarioLogado.login.email}</p></div>
        <a class="perfil__link" href=""><img class="perfil__imagem" src="./assets/informacoescliente.png" alt=""> <p>Minhas informações <br> Informações referentes ao uso da sua conta</p></a>
        <a class="perfil__link" href=""><img class="perfil__imagem" src="./assets/cartao.png" alt=""> <p>Cartões<br>Cartões salvos na sua conta</p></a>
